...
SDK_DOWNLOAD_URL=https://s3.intranet.rog2.org/software/android/android-sdk_r24.4.1-linux.tar.gz
NDK_DOWNLOAD_URL=https://s3.intranet.rog2.org/software/android/android-ndk-r12b-linux-x86_64.zip
